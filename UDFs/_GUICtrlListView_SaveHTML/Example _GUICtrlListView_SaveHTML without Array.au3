...
Func _Main()
	Local $hListView, $iButton, $iListView, $sPrintOut
...
; Syntax.........: _GUICtrlListView_SaveHTML($hListView, $sFile, [$sURL = ""])
...
; Example........; Yes
;=====================================================================================================================
Func _GUICtrlListView_SaveHTML($hListView, $sFile, $sURL = "")
	...
	For $A = 0 To $iColumnCount - 1
		...
		$sHTMLColumns &= @TAB & '<th>' & $aColumns[5] & '</th>' & @CRLF
	Next
	...
	For $A = 0 To $iItemCount - 1 ; ListView Items.
		...
		$sHTMLBody &= @TAB & '<td>' & $A + 1 & '</td>' & @CRLF
		For $B = 0 To $iColumnCount - 1
			$sIndex = _GUICtrlListView_GetItemText($hListView, $A, $B)
